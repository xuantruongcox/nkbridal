...
<head>
	<title>Angular FlexSlider Example - Add and Remove Slides</title>
...
<body ng-controller="BasicSliderCtrl">
	...
	<button ng-click="addRandomSlide()">Add Slide</button>
	<button ng-click="removeRandomSlide()">Remove Slide</button>
